// devopsHandler.js (extract to e.g. src/handlers/devopsHandler.js)
...
// == Portable handler function! ==
async function devopsHandler(req, res) {
  // Vercel and Express both have req.method, req.body
  if (req.method !== 'POST') {
